...
#include  <stdio.h>
	...
	int main (void) {
        ...
        printf("PROGRAMA PARA PROMEDIAR LOS ELEMENTOS DE UN ARREGLO\n");
        ...
        printf("\n\nEL promedio del arreglo es: %d", suma/n);
        //Para promediar unicamente necesitamos dividir el -
        //valor de la suma entre la cantidad (n) que ingresamos al arreglo
